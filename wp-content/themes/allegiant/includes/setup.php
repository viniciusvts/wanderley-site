...
function cpotheme_theme_layout( $data ) {
	...
	add_action( 'cpotheme_title_blog', 'cpotheme_page_title_blog' );
	// add_action( 'cpotheme_title', 'cpotheme_breadcrumb' );
	add_action( 'cpotheme_bread', 'cpotheme_breadcrumb' );
	...
	add_action( 'cpotheme_logo', 'cpotheme_logo' );
	add_action( 'cpotheme_menu_toggle', 'cpotheme_menu_toggle' );
}
